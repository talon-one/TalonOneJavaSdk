...
public class NewLoyaltyProgram {
  ...
  **/
  ...
  @Override
  public int hashCode() {
    return Objects.hash(title, description, subscribedApplications, defaultValidity, defaultPending, allowSubledger, usersPerCardLimit, sandbox, tiersExpirationPolicy, tiersExpireIn, tiersDowngradePolicy, programJoinPolicy, name, tiers, timezone, cardBased);
  }

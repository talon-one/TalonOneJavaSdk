...
public class InlineResponse20010 {
  ...
  public InlineResponse20010 totalResultSize(Long totalResultSize) {
  ...
  **/
  ...
  public InlineResponse20010 data(List<Ruleset> data) {
    
    this.data = data;
    return this;
  }

  public InlineResponse20010 addDataItem(Ruleset dataItem) {

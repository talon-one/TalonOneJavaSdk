 ...
 */
@ApiModel(description = "Resource definition for the SCIM provisioning protocol.")
...
public class ScimResource {
  ...
  public ScimResource id(String id) {
  ...
  **/
  ...
  public ScimResource name(String name) {
  ...
  **/
  ...
  public ScimResource description(String description) {

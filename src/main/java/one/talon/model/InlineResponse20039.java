...
public class InlineResponse20039 {
  ...
  **/
  ...
  public InlineResponse20039 data(List<WebhookWithOutgoingIntegrationDetails> data) {
    
    this.data = data;
    return this;
  }

  public InlineResponse20039 addDataItem(WebhookWithOutgoingIntegrationDetails dataItem) {

...
public class OutgoingIntegrationWebhookTemplates {
  ...
  private List<OutgoingIntegrationWebhookTemplate> data = null;


  public OutgoingIntegrationWebhookTemplates data(List<OutgoingIntegrationWebhookTemplate> data) {
  ...
  public OutgoingIntegrationWebhookTemplates addDataItem(OutgoingIntegrationWebhookTemplate dataItem) {
    if (this.data == null) {
      this.data = new ArrayList<OutgoingIntegrationWebhookTemplate>();
    }
  ...
  **/
  ...
  public List<OutgoingIntegrationWebhookTemplate> getData() {
    return data;
  }


  public void setData(List<OutgoingIntegrationWebhookTemplate> data) {
    this.data = data;
  }

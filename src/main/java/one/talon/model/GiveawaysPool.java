...
public class GiveawaysPool {
  ...
  **/
   ...
   * @return name
  **/
  @ApiModelProperty(required = true, value = "The name of this giveaways pool.")
  ...
  **/
  ...
  @ApiModelProperty(value = "The description of this giveaways pool.")
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(value = "A list of the IDs of the applications that this giveaways pool is enabled for")
  ...
  **/
  ...
  @Override
  public int hashCode() {
    return Objects.hash(id, created, accountId, name, description, subscribedApplicationsIds, modified, createdBy, modifiedBy);
  }

...
public class ActivateLoyaltyPoints {
  ...
  **/
  ...
  @ApiModelProperty(example = "[8f1a8d7c-9c3e-4a5e-9f0d-2c5f7a3b1cde]", value = "An array of transaction UUIDs used to activate specific pending point transactions.  If provided, do not include the `sessionId` parameter. ")
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(example = "ac08cc3c43470426591ad75b2d685ec04_v2", value = "The ID of the session containing the pending point transactions to activate.  If provided, do not include the `transactionUUIDs` parameter. ")

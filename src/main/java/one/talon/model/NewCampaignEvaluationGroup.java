...
public class NewCampaignEvaluationGroup {
  ...
  public NewCampaignEvaluationGroup name(String name) {
  ...
  public NewCampaignEvaluationGroup description(String description) {
  ...
  public NewCampaignEvaluationGroup evaluationMode(EvaluationModeEnum evaluationMode) {
  ...
  public NewCampaignEvaluationGroup locked(Boolean locked) {

...
public class NewCampaignTemplate {
  ...
  **/
  ...
  @Override
  public int hashCode() {
    return Objects.hash(name, description, instructions, campaignAttributes, couponAttributes, state, tags, features, couponSettings, referralSettings, limits, templateParams, campaignCollections);
  }

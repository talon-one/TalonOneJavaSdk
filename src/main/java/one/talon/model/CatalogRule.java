 ...
 */
@ApiModel(description = "A rule template stored in a catalog entry. Rules in catalog entries only contain title (no description, as description is at the catalog entry level).")
...
public class CatalogRule {
  ...
  public CatalogRule title(String title) {
  ...
  **/
  ...
  public CatalogRule bindings(List<Binding> bindings) {
  ...
  **/
  ...
  public CatalogRule condition(List<Object> condition) {
  ...
  **/
  ...
  public CatalogRule effects(List<Object> effects) {

...
public class CampaignStoreBudgetLimitConfig {
  ...
  public CampaignStoreBudgetLimitConfig action(String action) {
  ...
  **/
  ...
  public CampaignStoreBudgetLimitConfig limit(BigDecimal limit) {
  ...
  **/
  ...
  public CampaignStoreBudgetLimitConfig period(PeriodEnum period) {
  ...
  **/
  ...
  public CampaignStoreBudgetLimitConfig entities(List<EntitiesEnum> entities) {
  ...
  **/
  ...
  public CampaignStoreBudgetLimitConfig imported(Boolean imported) {
   ...
   * @return imported
  **/
  @ApiModelProperty(required = true, value = "Indicates whether this limit configuration is managed via a CSV file.")

...
public class RollbackAddedLoyaltyPointsEffectProps {
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(value = "The sub-position is returned when [cart item flattening](https://docs.talon.one/docs/product/campaigns/campaign-evaluation#flattening) is enabled. It indicates to which item the loyalty points were rolled back, for cart items with `quantity` > 1. ")

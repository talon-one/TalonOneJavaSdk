...
public class InlineResponse20041 {
  ...
  **/
  ...
  public InlineResponse20041 data(List<WebhookWithOutgoingIntegrationDetails> data) {
    
    this.data = data;
    return this;
  }

  public InlineResponse20041 addDataItem(WebhookWithOutgoingIntegrationDetails dataItem) {

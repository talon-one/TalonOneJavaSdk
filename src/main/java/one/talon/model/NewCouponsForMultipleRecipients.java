...
public class NewCouponsForMultipleRecipients {
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(value = "List of characters used to generate the random parts of a code. By default, the list of characters is equivalent to the `[A-Z, 0-9]` regular expression. ")
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(value = "The pattern used to generate coupon codes. The character `#` is a placeholder and is replaced by a random character from the `validCharacters` set. ")

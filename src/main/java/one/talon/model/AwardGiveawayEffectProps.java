...
public class AwardGiveawayEffectProps {
   ...
   * @return poolId
  **/
  @ApiModelProperty(required = true, value = "The ID of the giveaways pool the code was taken from.")
   ...
   * @return poolName
  **/
  @ApiModelProperty(required = true, value = "The name of the giveaways pool the code was taken from.")
  ...
  **/
  @ApiModelProperty(required = true, value = "The integration ID of the profile that was awarded the giveaway.")
   ...
   * @return giveawayId
  **/
  @ApiModelProperty(required = true, value = "The internal ID for the giveaway that was awarded.")
   ...
   * @return code
  **/
  @ApiModelProperty(required = true, value = "The giveaway code that was awarded.")

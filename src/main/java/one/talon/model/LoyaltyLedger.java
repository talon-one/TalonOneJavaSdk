...
public class LoyaltyLedger {
  ...
  **/
  ...
  @ApiModelProperty(example = "{\"mysubledger\":{\"activePoints\":286,\"pendingPoints\":50,\"spentPoints\":150,\"expiredPoints\":25}}", value = "A map containing a list of all loyalty subledger balances.")

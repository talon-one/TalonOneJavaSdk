...
public class AchievementV2 {
  ...
  public AchievementV2 id(Long id) {
  ...
  **/
  ...
  public AchievementV2 created(OffsetDateTime created) {
  ...
  **/
  ...
  public AchievementV2 name(String name) {
  ...
  **/
  ...
  public AchievementV2 title(String title) {
  ...
  **/
  ...
  public AchievementV2 description(String description) {
  ...
  **/
  ...
  public AchievementV2 target(BigDecimal target) {
  ...
  **/
  ...
  public AchievementV2 period(String period) {
  ...
  **/
  ...
  public AchievementV2 recurrencePolicy(RecurrencePolicyEnum recurrencePolicy) {
  ...
  **/
  ...
  public AchievementV2 activationPolicy(ActivationPolicyEnum activationPolicy) {
  ...
  **/
  ...
  public AchievementV2 fixedStartDate(OffsetDateTime fixedStartDate) {
  ...
  **/
  ...
  public AchievementV2 endDate(OffsetDateTime endDate) {
  ...
  **/
  ...
  public AchievementV2 allowRollbackAfterCompletion(Boolean allowRollbackAfterCompletion) {
  ...
  **/
  ...
  public AchievementV2 sandbox(Boolean sandbox) {
   ...
   * @return sandbox
  **/
  @ApiModelProperty(example = "true", required = true, value = "Indicates if this achievement is a live or sandbox achievement. Achievements of a given type can only be connected to Applications of the same type.")
  ...
  public AchievementV2 subscribedApplications(List<Long> subscribedApplications) {
  ...
  **/
  @ApiModelProperty(example = "[132, 97]", required = true, value = "A list containing the IDs of all applications that are subscribed to A list containing the IDs of all Applications that are connected to this achievement.")
  ...
  public AchievementV2 timezone(String timezone) {
  ...
  **/
  ...
  public AchievementV2 userId(Long userId) {
  ...
  **/
  ...
  public AchievementV2 createdBy(String createdBy) {
  ...
  **/
  ...
  public AchievementV2 hasProgress(Boolean hasProgress) {
  ...
  **/
  ...
  public AchievementV2 status(StatusEnum status) {

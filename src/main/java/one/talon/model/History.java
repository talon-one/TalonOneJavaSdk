...
public class History {
  ...
  **/
  ...
  public History observedAt(OffsetDateTime observedAt) {
  ...
  **/
  ...
  public History contextId(String contextId) {
   ...
   * @return contextId
  **/
  @ApiModelProperty(example = "Summer Sale 2025", required = true, value = "Identifier of the relevant context at the time the price was observed (e.g. summer sale). ")
  ...
  public History price(BigDecimal price) {
  ...
  **/
  ...
  public History metadata(BestPriorPriceMetadata metadata) {
  ...
  **/
  ...
  public History target(Object target) {

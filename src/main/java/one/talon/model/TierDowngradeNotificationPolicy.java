...
public class TierDowngradeNotificationPolicy {
  ...
  public TierDowngradeNotificationPolicy name(String name) {
   ...
   * @return name
  **/
  @ApiModelProperty(example = "Christmas Sale", required = true, value = "The name of the notification.")
  ...
  public TierDowngradeNotificationPolicy batchingEnabled(Boolean batchingEnabled) {
  ...
  **/
  ...
  public TierDowngradeNotificationPolicy batchSize(Integer batchSize) {

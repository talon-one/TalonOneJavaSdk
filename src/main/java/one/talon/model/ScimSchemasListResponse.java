 ...
 */
@ApiModel(description = "List of resource schemas supported by the SCIM provisioning protocol.")

public class ScimSchemasListResponse {
  public static final String SERIALIZED_NAME_RESOURCES = "Resources";
  @SerializedName(SERIALIZED_NAME_RESOURCES)
  private List<ScimSchemaResource> resources = new ArrayList<ScimSchemaResource>();

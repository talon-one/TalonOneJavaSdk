 ...
 */
@ApiModel(description = "Configuration settings related to patch operations, which allow partial updates to SCIM resources.")
...
public class ScimServiceProviderConfigResponsePatch {
  ...
  public ScimServiceProviderConfigResponsePatch supported(Boolean supported) {
  ...
  **/
  ...
  @ApiModelProperty(value = "Indicates whether the service provider supports patch operations for modifying resources.")

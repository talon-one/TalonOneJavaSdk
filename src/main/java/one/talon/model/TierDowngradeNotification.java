...
public class TierDowngradeNotification {
  ...
  private List<TierDowngradeData> data = new ArrayList<TierDowngradeData>();
  ...
  public TierDowngradeNotification totalResultSize(Long totalResultSize) {
  ...
  **/
  ...
  public TierDowngradeNotification data(List<TierDowngradeData> data) {
   ...
   * @return data
  **/
  @ApiModelProperty(required = true, value = "The array of tier downgrade notifications.")
  ...
  public void setData(List<TierDowngradeData> data) {
    this.data = data;
  }


  public TierDowngradeNotification notificationType(NotificationTypeEnum notificationType) {

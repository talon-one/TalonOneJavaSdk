...
public class InlineResponse20013 {
  ...
  public InlineResponse20013 totalResultSize(Long totalResultSize) {
  ...
  **/
  ...
  public InlineResponse20013 data(List<CampaignGroup> data) {
    
    this.data = data;
    return this;
  }

  public InlineResponse20013 addDataItem(CampaignGroup dataItem) {

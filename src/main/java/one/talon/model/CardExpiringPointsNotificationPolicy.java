...
public class CardExpiringPointsNotificationPolicy {
  ...
  private List<CardExpiringPointsNotificationTrigger> triggers = new ArrayList<CardExpiringPointsNotificationTrigger>();
  ...
  **/
  ...
  public CardExpiringPointsNotificationPolicy triggers(List<CardExpiringPointsNotificationTrigger> triggers) {
  ...
  **/
  ...
  public void setTriggers(List<CardExpiringPointsNotificationTrigger> triggers) {
    this.triggers = triggers;
  }


  public CardExpiringPointsNotificationPolicy batchingEnabled(Boolean batchingEnabled) {

...
public class CampaignStateChangedNotification {
  ...
  **/
   ...
   * @return oldState
  **/
  @ApiModelProperty(required = true, value = "The campaign's old state. Can be one of the following: ['running', 'disabled', 'scheduled', 'expired', 'draft', 'archived'] ")
   ...
   * @return newState
  **/
  @ApiModelProperty(required = true, value = "The campaign's new state. Can be one of the following: ['running', 'disabled', 'scheduled', 'expired', 'draft', 'archived'] ")
  ...
  @Override
  public int hashCode() {
    return Objects.hash(campaign, oldState, newState);
  }

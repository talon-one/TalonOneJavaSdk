 ...
 */
@ApiModel(description = "Configuration settings related to sorting SCIM resources in query responses.")
...
public class ScimServiceProviderConfigResponseSort {
  ...
  public ScimServiceProviderConfigResponseSort supported(Boolean supported) {
  ...
  **/
  ...
  @ApiModelProperty(value = "Indicates whether the service provider supports sorting operations for ordered query results.")

...
public class ActivateLoyaltyPointsResponse {
  ...
  private List<LoyaltyLedgerEntry> ledgerEntries = null;


  public ActivateLoyaltyPointsResponse ledgerEntries(List<LoyaltyLedgerEntry> ledgerEntries) {
  ...
  public ActivateLoyaltyPointsResponse addLedgerEntriesItem(LoyaltyLedgerEntry ledgerEntriesItem) {
    if (this.ledgerEntries == null) {
      this.ledgerEntries = new ArrayList<LoyaltyLedgerEntry>();
    }

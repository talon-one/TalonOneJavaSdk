...
public class InlineResponse20014 {
  ...
  public InlineResponse20014 totalResultSize(Long totalResultSize) {
  ...
  **/
  ...
  public InlineResponse20014 data(List<CampaignGroup> data) {
    
    this.data = data;
    return this;
  }

  public InlineResponse20014 addDataItem(CampaignGroup dataItem) {

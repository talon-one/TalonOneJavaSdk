...
public class CustomerSession {
  ...
  /**
   * A key-value map of the sessions attributes. The potentially valid attributes
   * are configured in your accounts developer settings.
   * 
   * @return attributes
   **/
   ...
   * Will always be true for anonymous sessions.
   * 
   * @return firstSession
   **/
  ...
  /**
   * A map of labelled discount values, values will be in the same currency as the
  ...
  @Override
  public int hashCode() {
    return Objects.hash(integrationId, created, applicationId, profileId, coupon, referral, state, cartItems,
        identifiers, total, attributes, firstSession, discounts, updated);
  }

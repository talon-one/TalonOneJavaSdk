...
public class ApplicationCustomer {
  ...
  public ApplicationCustomer sandbox(Boolean sandbox) {
  ...
  /**
   * The Integration ID of the Customer Profile that referred this Customer in the
   * Application.
   * 
  ...
  public int hashCode() {
    return Objects.hash(id, created, integrationId, attributes, accountId, closedSessions, totalSales,
        loyaltyMemberships, audienceMemberships, lastActivity, sandbox, advocateIntegrationId);
  }

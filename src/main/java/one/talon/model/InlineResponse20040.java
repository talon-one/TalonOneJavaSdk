...
public class InlineResponse20040 {
  ...
  public InlineResponse20040 totalResultSize(Long totalResultSize) {
  ...
  **/
  ...
  public InlineResponse20040 data(List<WebhookWithOutgoingIntegrationDetails> data) {
    
    this.data = data;
    return this;
  }

  public InlineResponse20040 addDataItem(WebhookWithOutgoingIntegrationDetails dataItem) {

...
public class TierUpgradeNotification {
  ...
  **/
  ...
  public TierUpgradeNotification data(List<TierUpgradeData> data) {
   ...
   * @return data
  **/
  @ApiModelProperty(required = true, value = "The array of tier upgrade notifications.")
  ...
  public void setData(List<TierUpgradeData> data) {
    this.data = data;
  }

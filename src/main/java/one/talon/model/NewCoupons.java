...
public class NewCoupons {
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(example = "", value = "**DEPRECATED** To create more than 20,000 coupons in one request, use [Create coupons asynchronously](https://docs.talon.one/management-api#tag/Coupons/operation/createCouponsAsync) endpoint. ")

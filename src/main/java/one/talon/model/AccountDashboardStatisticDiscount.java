...
public class AccountDashboardStatisticDiscount {
  ...
  public AccountDashboardStatisticDiscount total(BigDecimal total) {
   ...
   * @return total
  **/
  @ApiModelProperty(required = true, value = "Total discount value redeemed by users.")
  ...
  public AccountDashboardStatisticDiscount average(BigDecimal average) {
   ...
   * @return average
  **/
  @ApiModelProperty(required = true, value = "Average discount percentage.")
  ...
  public AccountDashboardStatisticDiscount datetime(OffsetDateTime datetime) {

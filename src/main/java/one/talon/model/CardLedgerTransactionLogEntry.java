...
public class CardLedgerTransactionLogEntry {
  ...
  **/
  @ApiModelProperty(example = "summer-loyalty-card-0543", required = true, value = "The identifier of the loyalty card, which must match the regular expression `^[A-Za-z0-9._%+@-]+$`. ")

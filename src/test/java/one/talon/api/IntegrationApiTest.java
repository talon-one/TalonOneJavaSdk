...
public class IntegrationApiTest {
    ...
    public void trackEventTest() throws ApiException {
        ...
        IntegrationState response = api.trackEvent(newEvent);
    ...
    public void updateCustomerProfileTest() throws ApiException {
        ...
        IntegrationState response = api.updateCustomerProfile(integrationId, newCustomerProfile);
    ...
    public void updateCustomerSessionTest() throws ApiException {
        ...
        IntegrationState response = api.updateCustomerSession(customerSessionId, newCustomerSession);

...
**applicationCount** | **Integer** | The current number of Applications in your account. |  [optional]
**userCount** | **Integer** | The current number of Campaign Manager Users in your account. |  [optional]
**campaignsActiveCount** | **Integer** | The current number of active Campaigns in your account. |  [optional]
**campaignsInactiveCount** | **Integer** | The current number of inactive Campaigns in your account. |  [optional]
**apiCallCount** | **Integer** | The number of Integration API calls that have been made. |  [optional]
